...
kube-system   machinedeployment.cluster.k8s.io/k1-pool-az-c   1          1                    gce        ubuntu   1.20.9    78m

NAMESPACE     NAME                                                   PROVIDER   OS       ADDRESS       KUBELET   AGE
kube-system   machine.cluster.k8s.io/k1-pool-az-a-6d996bd447-8skhq   gce        coreos                 1.20.9    16s
kube-system   machine.cluster.k8s.io/k1-pool-az-a-75cddb6cd9-slgqk   gce        ubuntu   10.240.0.13   1.20.9    78m
kube-system   machine.cluster.k8s.io/k1-pool-az-b-777d7cc84b-g76zf   gce        ubuntu   10.240.0.15   1.20.9    78m
kube-system   machine.cluster.k8s.io/k1-pool-az-c-5d5cfcc5bf-gpjpg   gce        ubuntu   10.240.0.14   1.20.9    78m

NAMESPACE   NAME                                 STATUS   ROLES    AGE     VERSION
            node/k1-control-plane-1              Ready    master   5h25m   v1.20.9
            node/k1-control-plane-2              Ready    master   4h49m   v1.20.9
            node/k1-control-plane-3              Ready    master   4h48m   v1.20.9
            node/k1-pool-az-a-75cddb6cd9-slgqk   Ready    <none>   75m     v1.20.9
...
machinedeployment.cluster.k8s.io/k1-pool-az-c   1          1                    gce        ubuntu   1.20.9    66m   

NAME                                                   PROVIDER   OS       MACHINESET                NODE                            ADDRESS       KUBELET   AGE     DELETED
machine.cluster.k8s.io/k1-pool-az-a-7f976c98dd-fp4xt   gce        ubuntu   k1-pool-az-a-7f976c98dd   k1-pool-az-a-7f976c98dd-fp4xt   10.240.0.7    1.20.9    78m     5s
machine.cluster.k8s.io/k1-pool-az-a-bd95f5c65-pmzfb    gce        ubuntu   k1-pool-az-a-bd95f5c65    k1-pool-az-a-bd95f5c65-pmzfb    10.240.0.10   1.20.9    2m50s   
machine.cluster.k8s.io/k1-pool-az-b-6996d8f668-2wfp4   gce        ubuntu   k1-pool-az-b-6996d8f668                                   10.240.0.11   1.20.9    2m4s    
machine.cluster.k8s.io/k1-pool-az-b-6b7fcd6985-wd6fm   gce        ubuntu   k1-pool-az-b-6b7fcd6985   k1-pool-az-b-6b7fcd6985-wd6fm   10.240.0.8    1.20.9    66m     
machine.cluster.k8s.io/k1-pool-az-c-66f96d6b66-nvjfk   gce        ubuntu   k1-pool-az-c-66f96d6b66   k1-pool-az-c-66f96d6b66-nvjfk   10.240.0.9    1.20.9    66m     
machine.cluster.k8s.io/k1-pool-az-c-7bdfbcd567-cb5kb   gce        ubuntu   k1-pool-az-c-7bdfbcd567                                   10.240.0.12   1.20.9    2m4s    

NAME                                 STATUS                     ROLES    AGE   VERSION   INTERNAL-IP   EXTERNAL-IP      OS-IMAGE             KERNEL-VERSION   CONTAINER-RUNTIME
node/k1-control-plane-1              Ready                      master   11h   v1.20.9   10.240.0.2    34.141.138.245   Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.14
node/k1-control-plane-2              Ready                      master   84m   v1.20.9   10.240.0.4    34.141.210.40    Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.14
node/k1-control-plane-3              Ready                      master   83m   v1.20.9   10.240.0.5    34.141.148.120   Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.14
node/k1-pool-az-a-7f976c98dd-fp4xt   Ready,SchedulingDisabled   <none>   75m   v1.20.9   10.240.0.7    34.141.201.46    Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.13
node/k1-pool-az-a-bd95f5c65-pmzfb    Ready                      <none>   26s   v1.20.9   10.240.0.10   34.141.168.104   Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.13
...
NAME                                                   PROVIDER   OS       MACHINESET                NODE                            ADDRESS       KUBELET   AGE     DELETED
machine.cluster.k8s.io/k1-pool-az-a-bd95f5c65-pmzfb    gce        ubuntu   k1-pool-az-a-bd95f5c65    k1-pool-az-a-bd95f5c65-pmzfb    10.240.0.10   1.20.9    5m11s   
machine.cluster.k8s.io/k1-pool-az-b-6996d8f668-2wfp4   gce        ubuntu   k1-pool-az-b-6996d8f668   k1-pool-az-b-6996d8f668-2wfp4   10.240.0.11   1.20.9    4m25s   
machine.cluster.k8s.io/k1-pool-az-c-7bdfbcd567-cb5kb   gce        ubuntu   k1-pool-az-c-7bdfbcd567   k1-pool-az-c-7bdfbcd567-cb5kb   10.240.0.12   1.20.9    4m25s   

NAME                                 STATUS   ROLES    AGE     VERSION   INTERNAL-IP   EXTERNAL-IP      OS-IMAGE             KERNEL-VERSION   CONTAINER-RUNTIME
node/k1-control-plane-1              Ready    master   11h     v1.20.9   10.240.0.2    34.141.138.245   Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.14
node/k1-control-plane-2              Ready    master   86m     v1.20.9   10.240.0.4    34.141.210.40    Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.14
node/k1-control-plane-3              Ready    master   85m     v1.20.9   10.240.0.5    34.141.148.120   Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.14
node/k1-pool-az-a-bd95f5c65-pmzfb    Ready    <none>   2m47s   v1.20.9   10.240.0.10   34.141.168.104   Ubuntu 18.04.5 LTS   5.4.0-1043-gcp   docker://19.3.13
...
machinedeployment.cluster.k8s.io/k1-pool-az-c   0                               gce        ubuntu   1.20.9    69m

NAME                                                   PROVIDER   OS       ADDRESS       KUBELET   AGE
machine.cluster.k8s.io/k1-pool-az-a-bd95f5c65-pmzfb    gce        ubuntu   10.240.0.10   1.20.9    6m5s
machine.cluster.k8s.io/k1-pool-az-b-6996d8f668-2wfp4   gce        ubuntu   10.240.0.11   1.20.9    5m19s
machine.cluster.k8s.io/k1-pool-az-c-7bdfbcd567-cb5kb   gce        ubuntu   10.240.0.12   1.20.9    5m19s

NAME                                 STATUS                     ROLES    AGE     VERSION
node/k1-control-plane-1              Ready                      master   11h     v1.20.9
node/k1-control-plane-2              Ready                      master   87m     v1.20.9
node/k1-control-plane-3              Ready                      master   86m     v1.20.9
node/k1-pool-az-a-bd95f5c65-pmzfb    Ready,SchedulingDisabled   <none>   3m41s   v1.20.9
...
k1-control-plane-3   Ready    master   88m   v1.20.9
```
